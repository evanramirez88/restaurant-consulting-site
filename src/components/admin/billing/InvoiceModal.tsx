                      ...
                      <div className="flex gap-3">
                        ...
                        {lineItems.length > 1 && (
                          <button
                            ...
                            className="self-end p-3 text-red-400 hover:text-red-300 hover:bg-red-500/10 rounded-lg transition-all active:scale-90 min-h-[48px] min-w-[48px] flex items-center justify-center"
